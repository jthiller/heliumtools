  ...
  const content = `
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 32px;">
      ...
      <div>
        ...
        <p style="margin: 0; font-size: 32px; font-weight: 700; color: ${getDaysColor(daysRemaining)}; letter-spacing: -0.025em; line-height: 1.1;">${daysRemaining != null ? (() => { const r = Math.round(daysRemaining * 10) / 10; return r % 1 === 0 ? r : r.toFixed(1); })() : 'N/A'}</p>
